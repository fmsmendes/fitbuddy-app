...
import { User, Mail, MapPin, Calendar, Activity, Award, Edit, LogOut, Clock, Star, Heart, Target, Save, X, Stretch, Dumbbell, Bike, Swim, Tennis, Mountain, Snowflake } from 'lucide-react';
                ...
                {isEditing ? (
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      { icon: <Stretch size={20} />, label: 'Yoga' },

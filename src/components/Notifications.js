    ...
    <div className="max-w-2xl mx-auto p-4">
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="flex border-b">
          <button
            className={`flex-1 py-2 px-4 text-center ${activeTab === 'general' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-700'}`}
            onClick={() => setActiveTab('general')}
          >
            General
          </button>
          <button
            className={`flex-1 py-2 px-4 text-center ${activeTab === 'requests' ? 'bg-orange-500 text-white' : 'bg-gray-100 text-gray-700'}`}
